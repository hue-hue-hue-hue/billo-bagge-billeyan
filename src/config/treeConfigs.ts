...
export const getTreeConfig = (state: TreeState) => {
  switch (state) {
    case TreeState.SRETRIVAL:
      return {
        nodes: [giveSingleNode(TreeState.SRETRIVAL)],
        edges: [],
      };
    case TreeState.EXPANDED_QUERY:
      return {
        nodes: [giveSingleNode(TreeState.EXPANDED_QUERY)],
        edges: [],
      };
    case TreeState.RETRIVAL_CALL:
      return {
